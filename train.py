...
def train_st1(gen, dis, pose_net, dataloaders,optims, criterions, schedulers, epochs):
...
def train_st2(gen, dis, pose_net, dataloaders,optims, criterions, schedulers, epochs):
    g_optim, d_optim, h_optim = optims
    gan_loss, hp_loss = criterions
    g_ched, d_sched, h_sched = schedulers
    Fdataloader, Rdataloader, HPdataloader = dataloaders
